...
<div class="layui-layout layui-layout-admin"> <!-- 添加skin-1类可手动修改主题为纯白，添加skin-2类可手动修改主题为蓝白 -->
    ...
    <div class="layui-header my-header">
        ...
        <ul class="layui-nav my-header-user-nav" lay-filter="side-top-right">
            ...
            <li class="layui-nav-item">
                <a class="name" href="javascript:;"><img src="<%=basePath%>houtai/muban2/static/image/code.png" alt="logo"><%=adminName %></a>
                <dl class="layui-nav-child">
                    <dd><a href="javascript:;" href-url="<%=basePath%>shouye/neiye.jsp"><i class="layui-icon">&#xe621;</i>登录页</a></dd>
                    <dd><a href="javascript:;" href-url="<%=basePath%>admin/adminmima.jsp"><i class="layui-icon">&#xe621;</i>修改密码</a></dd>
               ...
               <li class="layui-nav-item  layui-nav-itemed">
                ...
                <li class="layui-nav-item">
                    ...
                    <%for(int j = 0; j < jcdaohangslist.get(i).size(); j++){ %>
                    	<dd><a href="javascript:;" href-url="<%=basePath%>admin/<%=jcdaohangslist.get(i).get(j).getJcdaohangNeirong() %>"><i class="layui-icon">&#xe621;</i><%=jcdaohangslist.get(i).get(j).getJcdaohangName() %></a></dd>
                    <%} %>
                    </dl>
                </li>
                <%} %>
