...
var url;
	...
	function openSjshaochuAddDialog(){
		...
		url="../addSjshaochu?sjshaochuType=1";
	}
	...
	function openSjshaochuModifyDialog(){
		...
		$("#fm").form("load",row);
		url="../addSjshaochu?sjshaochuType=2&sjshaochuId="+row.sjshaochuId;
	}
...
<!--startprint-->
	<table id="dg" title="<%=newJcpeizhi.getShujuBieming()%><%=newJcpeizhi.getSjshaochuBieming()%>" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSjshaochus?sjshaochuType=1" fit="true" rownumbers="true" toolbar="#tb" nowrap="false">
		<thead>
			<tr>
	...
	<div id="tb">
		<div>
			<a href="javascript:openSjshaochuModifyDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">发快递</a>
		</div>
		<div>
