...
<body style="margin: 5px;">
	<table id="dg" title="<%=newJcpeizhi.getGonggaoBieming()%><%=newJcpeizhi.getGgtypeBieming()%>" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getGgtypes" fit="true" rownumbers="true" toolbar="#tb" nowrap="false">
		<thead>
			<tr>
	...
	<div id="tb">
		<div>
			...
			<a href="javascript:deleteGgtype()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除</a>
		</div>
	</div>
