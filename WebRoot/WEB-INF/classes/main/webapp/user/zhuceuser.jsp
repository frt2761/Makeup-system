...
<title>用户注册</title>
<link rel="stylesheet" type="text/css" href="<%=basePath %>jquery-easyui-1.3.3/themes/ui-pepper-grinder/easyui.css">
...
#login .logo{height:78px; text-align:center; font-size:30px; font-weight:bold; color:#393D49; margin-top:40px;}
...
#login .main form ul li .bnt{width:292px;border:0;background:#393D49;color:#fff;border-radius:4px;padding:12px 0;margin:0;font-size:16px;font-family:microsoft yahei;cursor:pointer;}
...
<div id="login">
        ...
        <div class="main">
            ...
            <ul>
                ...
                <li>地&nbsp;&nbsp;&nbsp;&nbsp;址：<input class="wa" type="text" name="userMark" id="userMark"/></li>
                <li>爱&nbsp;&nbsp;&nbsp;&nbsp;好：<input class="easyui-combobox" id="buyuanIds" name="buyuanIds"  data-options="multiple:true,panelHeight:'auto',editable:false,valueField:'buyuanId',textField:'buyuanName',url:'../buyuanComboList'"/></li>
