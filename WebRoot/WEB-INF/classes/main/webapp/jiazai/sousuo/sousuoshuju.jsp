...
<%
	...
	String sousuoShujuMark = (String) request.getParameter("shujuMark");
	...
	String sousuoShujuMark3 = (String) request.getParameter("shujuMark3");
	...
	if (StringUtil.isNotEmpty(sousuoShujuMark)) {
		sousuoShujuparam.append("&shujuMark=" + sousuoShujuMark);
	}
	...
	if (StringUtil.isNotEmpty(sousuoShujuMark3)) {
		sousuoShujuparam.append("&shujuMark3=" + sousuoShujuMark3);
	}
