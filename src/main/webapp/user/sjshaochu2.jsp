...
<!--startprint-->
	<table id="dg" title="<%=newJcpeizhi.getShujuBieming()%><%=newJcpeizhi.getSjshaochuBieming()%>" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSjshaochus?sjshaochuType=2&userId=<%=userId %>" fit="true" rownumbers="true" toolbar="#tb" nowrap="false">
		<thead>
			<tr>
	...
	<div id="tb">
		<div>
			<a href="javascript:shenheSjshaochu()" class="easyui-linkbutton" iconCls="icon-add" plain="true">确认收货</a>
		</div>
		<div>
