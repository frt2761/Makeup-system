...
<!--startprint-->
	<table id="dg" title="个人信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getUsers?userId=<%=userId %>" fit="true" rownumbers="true" toolbar="#tb" nowrap="false">
		<thead>
			<tr>
				...
				<th field="userMark" width="60">地址</th>
				<th field="buyuanName" width="60">爱好</th>
				<th field="userDouble" width="15">余额</th>
				<th field="userDouble1" width="15">积分</th>
				<th field="userDate" width="20" formatter="datetostr" hidden="true">时间</th>
			</tr>
		</thead>
	</table>
