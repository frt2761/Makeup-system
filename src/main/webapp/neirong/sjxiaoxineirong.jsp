      ...
      <tr>
        ...
        <td height="" valign="top" bgcolor="#FFFFFF" style="border:1px solid #e0e0e0; padding:10px; line-height:25px;">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30" align="center" class="line"><%=sjxiaoxi.getSjxiaoxiName()%></td>
                  </tr>
                  <tr>
                    <td align="left">
                    <p style="margin-top:10px; text-indent:2em;"><%=sjxiaoxi.getSjxiaoxiMark()%></p>
                    </td>
                  </tr>
			</table>
        </td>
